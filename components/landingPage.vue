<template>
    <header class="h-screen">
        <div class="flex flex-col justify-between items-center sm:flex-row md:flex-row-reverse w-full h-full">
            <div class="h-full bg-black text-white py-20 px-7 w-full sm:w-[50%] flex flex-col">
...
}" class="hidden sm:block h-full sm:w-[50%]">
                <SwiperSlide>
    ...
    <main>
        ...
        <div v-else>
            <Menus>
                <h2 class="text-center text-2xl">Our Menus</h2>
